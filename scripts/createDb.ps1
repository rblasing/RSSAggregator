...
$cmd.Connection = $db
$cmd.CommandText = "DROP TABLE profanity"
$cmd.ExecuteNonQuery()
...
$cmd.CommandText = "CREATE TABLE profanity (word NVARCHAR(30) PRIMARY KEY)"
$cmd.Connection = $db
$cmd.ExecuteNonQuery()
...
# I'll leave the remainder as an exercise for the reader
$profanity = "damn", "damned", "ass", "dumbass";

$profanity | foreach {
   $cmd = new-object System.Data.SqlClient.SqlCommand
   $cmd.CommandText = "INSERT INTO profanity (word) VALUES (@w)";
